...
@section('content')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Input -->
            <form id="request-form" class="forms-sample" action="{{ route('teams.update', $item->id) }}" method="POST"
                ...
                <div class="preview-component intro-y box mb-4">
                    <div class="p-5">
                        ...
                        <div class="preview relative">
                            ...
                            <input id="slug" name="slug" type="text" value="{{ old('slug', $item->slug) }}"
                        ...
                        <textarea id="content" name="content" rows="4" placeholder="Enter content"
                    ...
                    <div class="mt-4 masterx-validation">
                        ...
                        <input id="role" name="role" type="text" value="{{ old('role', $item->role) }}"
                    ...
                    <div class="mt-4 masterx-validation">
                        ...
                        <input id="facebook" name="facebook" type="text" value="{{ old('facebook', $item->facebook) }}"
                    ...
                    <div class="mt-4 masterx-validation">
                        ...
                        <input id="instagram" name="instagram" type="text"
                            value="{{ old('instagram', $item->instagram) }}" placeholder="Enter Instagram profile link"
                            class="w-full text-sm border-slate-200 shadow-sm rounded-md focus:ring-4 focus:ring-primary">
                    </div>
                    ...
                    <div class="mt-4 masterx-validation">
                        ...
                        <input id="twitter" name="twitter" type="text" value="{{ old('twitter', $item->twitter) }}"
                    ...
                    <div class="mt-4 masterx-validation">
                        ...
                        <input id="whatsapp" name="whatsapp" type="text" value="{{ old('whatsapp', $item->whatsapp) }}"

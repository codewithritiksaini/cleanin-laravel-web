...
<!-- BEGIN: Input -->
<form id="request-form" class="forms-sample" action="{{ route('projects.store') }}" method="POST" data-form-reset="true" data-load-table="false" enctype="multipart/form-data">
    @csrf

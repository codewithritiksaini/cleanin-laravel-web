...
<!-- END: Top Bar -->
    ...
    <h2 class="intro-y mt-10 text-lg font-medium">Blog</h2>
...
<i data-tw-merge="" data-lucide="plus-circle" class="stroke-1.5 w-5 h-5 mx-auto block"></i> &nbsp; Add New
Service
</a>
...
<table data-tw-merge="" class="w-full text-left -mt-2 border-separate border-spacing-y-[10px]"
    ...
    <thead data-tw-merge="" class="">
        <tr data-tw-merge="" class="">
            <th
                ...
                #</th>
            <th class="font-medium px-5 py-3 dark:border-darkmode-300 whitespace-nowrap border-b-0">IMAGE
            </th>
            <th
                class="font-medium px-5 py-3 dark:border-darkmode-300 whitespace-nowrap border-b-0 text-center">
                POST TITLE</th>
    ...
    <tbody>
                ...
                <td class="px-5 py-3 border-b dark:border-darkmode-300 box w-40 rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                                                        <img class="rounded" src="https://www.ritiksaini.in/storage/services/services_31240.jpg" alt="Custom Web Development Services | Fast, Secure &amp; SEO-Optimized Websites" style="width: 50px">
                    ;
                </td>
                <td
                    ...
                    Custom Web Development Services | Fast, Secure &amp; SEO-Optimized Websites
                </td>
                <td
                    class="px-5 py-3 border-b dark:border-darkmode-300 box rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                    Boost your online presence with expert web development services! Get custom, high-performance, and S
                </td>
                <td
                    class="px-5 py-3 border-b dark:border-darkmode-300 box rounded-l-none rounded-r-none border-x-0 shadow-[5px_3px_5px_#00000005] first:rounded-l-[0.6rem] first:border-l last:rounded-r-[0.6rem] last:border-r dark:bg-darkmode-600">
                    <label class="switch">
                        <input type="checkbox" onchange="changeStatus($(this))"
                            href="https://www.ritiksaini.in/admin/ajax/change-service-status/1"
                            checked>
                ...
                <td data-tw-merge=""
                    ...
                    <div class="flex items-center justify-center">
                        <a class="mr-3 flex items-center"
                            href="https://www.ritiksaini.in/admin/service/1/edit">
                        ...
                        <a class="flex items-center text-danger"
                            ...
                            href="https://www.ritiksaini.in/admin/service/1">

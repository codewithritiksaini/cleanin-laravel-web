...
<h2 class="mr-auto text-lg font-medium">Update {{$title}}</h2>
</div>
<div class="mt-5 grid grid-cols-12 gap-6">
<div class="intro-y col-span-12 lg:col-span-12">
<!-- BEGIN: Input -->
<form id="request-form" class="forms-sample" action="{{ route('about.update') }}" method="POST" data-form-reset="true" data-load-table="false" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="p-5">
            ...
            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                ...
                <div class="mt-4 masterx-validation">
                    ...
                    <textarea data-tw-merge="" style="height: 300px!important;" id="content" name="content" placeholder="Content"

...
<a href="https://www.ritiksaini.in/admin/service">Tesimonial</a>
</li>
<li
...
<!-- BEGIN: Input -->
<form id="request-form" class="forms-sample" action="https://www.ritiksaini.in/admin/service" method="POST" data-form-reset="true" data-load-table="false">
<input type="hidden" name="_token" value="kc15lic7hhcKjGbGl5zCaxigNMTZi0n6UcQgMXWM" autocomplete="off">                <div class="preview-component intro-y box mb-4">
    <div class="p-5">
